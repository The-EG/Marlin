...
#define USE_CONTROLLER_FAN
  ...
  #define CONTROLLERFAN_SPEED_MIN        65 // (0-255) Minimum speed. (If set below this value the fan is turned off.)
...
#define FAST_PWM_FAN    // Increase the fan PWM frequency. Removes the PWM noise but increases heating in the FET/Arduino
  ...
  #define FAST_PWM_FAN_FREQUENCY 25U  // Define here to override the defaults below
...
#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_XY { { 30, 200 }, {  30, 30 }, { 200,  30 }, { 200, 200 } }
...
#define LIN_ADVANCE
    ...
    #define ADVANCE_K 0.40    // (mm) Compression length per 1mm/s extruder speed, per extruder
  #else
    #define ADVANCE_K 0.40        // (mm) Compression length applying to all extruders
  #endif
 ...
 */
  ...
  #define PROBE_PT_1 {  30,  30 }   // (mm) { x, y }
  #define PROBE_PT_2 {  30, 195 }
  #define PROBE_PT_3 { 195,  30 }
#endif
...
#define MECHANICAL_GANTRY_CALIBRATION
  ...
  #define GANTRY_CALIBRATION_CURRENT          100     // Default calibration current in ma
