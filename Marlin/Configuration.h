...
#define STRING_CONFIG_H_AUTHOR "(Taylor Talkington, Ender-3 Pro Octopus v1.1" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-3 Pro Octopus"
...
#define TEMP_BOARD_PIN TEMP_1_PIN
 ...
 */
  ...
  #define MPC_BLOCK_HEAT_CAPACITY { 17.005f }           // (J/K) Heat block heat capacities.
  #define MPC_SENSOR_RESPONSIVENESS { 0.2729f }         // (K/s per ∆K) Rate of change of sensor temperature from heat block.
  #define MPC_AMBIENT_XFER_COEFF { 0.1236f }           // (W/K) Heat transfer coefficients from heat block to room air with fan off.
  #if ENABLED(MPC_INCLUDE_FAN)
    #define MPC_AMBIENT_XFER_COEFF_FAN255 { 0.1687f }  // (W/K) Heat transfer coefficients from heat block to room air with fan on full.
  #endif
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT { 80, 80, 400, 132 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION { 7000, 7000, 100, 5000 }
...
#define Z_PROBE_SERVO_NR 0
  ...
  #define Z_SERVO_ANGLES { 180, 90 }      // Z Servo Deploy and Stow angles
...
#define Z_CLEARANCE_MULTI_PROBE     7 // (mm) Z Clearance between multiple probes
...
#define HOMING_FEEDRATE_MM_M { (30*60), (30*60), (9*60) }
...
#define NO_CONFIGURATION_EMBEDDING_WARNING 1

#define RET6_12864_LCD 1
