...
#define STRING_CONFIG_H_AUTHOR "(Taylor Talkington, Ender-3 Pro v4.2.7)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-3 Pro 427"
 ...
 */
  ...
  #define MPC_BLOCK_HEAT_CAPACITY { 15.21f }           // (J/K) Heat block heat capacities.
  #define MPC_SENSOR_RESPONSIVENESS { 0.3061f }         // (K/s per ∆K) Rate of change of sensor temperature from heat block.
  #define MPC_AMBIENT_XFER_COEFF { 0.0966f }           // (W/K) Heat transfer coefficients from heat block to room air with fan off.
  #if ENABLED(MPC_INCLUDE_FAN)
    #define MPC_AMBIENT_XFER_COEFF_FAN255 { 0.1028f }  // (W/K) Heat transfer coefficients from heat block to room air with fan on full.
  #endif
